...
public class PracticeFormPage extends BasePage {
    ...
    public PracticeFormPage enterPersonalData(String name, String surname,
        ...
        typeWithJs(firstName,name,0,200);
        type(lastName,surname);
        type(userEmail,email);
        typeWithJs(userNumber,phone,0,200);
        return this;
    }
    ...
    WebElement reading;
    @FindBy(id = "[for='hobbies-checkbox-3']")
    WebElement music;
    ...
    public PracticeFormPage verifySuccessRegistration(String title) {
        Assertions.assertTrue(shouldHaveText(modalTitle,title,5));
        return this;
    }
    ...
    public PracticeFormPage selectDate(String month, String year, String date) {
        ...
        driver.findElement(By.xpath("//div[@class='react-datepicker__week']//*[.='"+date+"']")).click();
        return this;
    }
}
